...
public:
    SesionEstudio(int minutosDescanso) {
        if (minutosDescanso <= 0 || minutosDescanso > 60) {
            ...
            minutosDescansoAsignado = 10;} else {minutosDescansoAsignado = minutosDescanso;}
    } 
    ...
    ~SesionEstudio() {std::cout << "Sesion de estudio finalizada" << std::endl;}
};
...
int main() {
    {
        ...
        std::cout << "Horario 1 aceptado: " << std::boolalpha << resultado1 << std::endl;

        SesionEstudio s2(90);
        bool resultado2 = s2.setHorario(23.0, 22.0);
        std::cout << "Horario 2 aceptado: " << std::boolalpha << resultado2 << std::endl;

        SesionEstudio s3(15);
        bool resultado3 = s3.setHorario(14.0, 16.0);
        std::cout << "Horario 3 aceptado: " << std::boolalpha << resultado3 << std::endl;
